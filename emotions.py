...
from tensorflow.keras.layers import Dense, Dropout, Flatten, Activation, AveragePooling2D
from tensorflow.keras.layers import Conv2D, Convolution2D, BatchNormalization, Input, SeparableConv2D
